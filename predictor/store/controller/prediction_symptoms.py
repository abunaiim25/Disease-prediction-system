...
def symptoms(request):
    ...
    return render(request, "store/prediction/diseases/symptoms/form.html", context)
...
def predictdisease(request):
    ...
    # Training dataset
    data = pd.read_csv(os.path.join('C:/xampp/htdocs/Django/Disease Predictor/predictor/machine_deep_learning', 'symptoms_disease.csv'))
    print(len(data))
    ...
    # Testing dataset
    dataset = pd.read_csv(os.path.join('C:/xampp/htdocs/Django/Disease Predictor/predictor/machine_deep_learning', 'symptoms_disease.csv'))
    ...
    if (h == 'yes'):
        ...
        disease = disease[a]
        context = {'disease': disease, 'psymptoms':psymptoms}
        return render(request, 'store/prediction/diseases/symptoms/result.html', context)
